...
<?php else : ?>
<h1 class="archive-title">Компрессоры для <?php single_cat_title() ?></h1>
<?php endif; ?>
      ...
      <ul class="parts-list">
        ...
        <li class="parts-list__item part">
          <a class="part__link" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>">
            ...
            <?php echo '<div class="part__link-price">'.get_post_meta( get_the_ID(), "price-exchange", true).' ₽</div>'; ?>
          </a>
        </li>
